...
struct QuantizedConvToConv : public OpRewritePattern<Conv2DQOpType> {
  ...
  LogicalResult matchAndRewrite(Conv2DQOpType op,
    ...
    getConv2DOpIndices(isNHWC, filterFDimIndex, filterCDimIndex, filterHDimIndex,
                       filterWDimIndex, inputNDimIndex, inputHDimIndex,
...
private:
  ...
  void getConv2DOpIndices(bool isNHWC, int &filterFDimIndex, int &filterCDimIndex,
                          int &filterHDimIndex, int &filterWDimIndex,
